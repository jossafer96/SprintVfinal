	...
	<div class="panel panel-info" style="border-color: #17202A; color:#af8d9d">
		<div class="panel-heading" style="background-color: #151515; color: #ffffff">
		    <div class="btn-group pull-right">
					<button type='button' class="btn btn-info" style="background-color: white; color: black; border: 1px solid #1C1C1C;" data-toggle="modal" data-target="#nuevoCliente"><span class="glyphicon glyphicon-plus" ></span> Nuevo Cliente</button>
				</div>
		...
		<div class="panel-body">
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input style="border: 1px solid #9e798a;" type="text" class="form-control" id="q" placeholder="Nombre del cliente" onkeyup='load(1);'>
							</div>
							<div class="col-md-3">
