    ...
    <div class="container">
		...
		<div class="panel-heading" style="background-color: #151515; color: #ffffff">
		    <div class="btn-group pull-right">
					<button type='button' class="btn btn-info" style="background-color: white; color: black; border: 1px solid #1C1C1C;" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus" ></span> Nuevo Usuario</button>
				</div>
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" style=" border: 1px solid #9e798a;" class="form-control" id="q" placeholder="Nombre del usuario" onkeyup='load(1);'>
							</div>
